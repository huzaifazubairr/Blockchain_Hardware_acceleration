...
# 33 "./sha256.h"
__attribute__((sdx_kernel("sha256_acc", 0))) void sha256_acc(hls::stream<uint32> &in_stream, hls::stream<pkt> &out_stream);
# 2 "sha256.cpp" 2

__attribute__((sdx_kernel("sha256_acc", 0))) void sha256_acc(hls::stream<uint32> &in_stream, hls::stream<pkt> &out_stream) {
#line 16 "D:/VLSI_Getting_in_Semiconductors/Projects/Blockchain_Hardware_accelration/Blockchaind_vitis/Blockchain_hardware_accelratoin/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=sha256_acc
# 3 "sha256.cpp"

#line 6 "D:/VLSI_Getting_in_Semiconductors/Projects/Blockchain_Hardware_accelration/Blockchaind_vitis/Blockchain_hardware_accelratoin/solution1/directives.tcl"
#pragma HLSDIRECTIVE TOP name=sha256_acc
# 3 "sha256.cpp"
...
#pragma HLS PIPELINE II=1
 w[i] = in_stream.read();
    ...
    VITIS_LOOP_21_2: for (int i = 16; i < 64; i++) {
#pragma HLS PIPELINE II=2
 w[i] = ((((w[i-2]) >> (17)) | ((w[i-2]) << (32 - (17)))) ^ (((w[i-2]) >> (19)) | ((w[i-2]) << (32 - (19)))) ^ ((w[i-2]) >> 10)) + w[i-7] + ((((w[i-15]) >> (7)) | ((w[i-15]) << (32 - (7)))) ^ (((w[i-15]) >> (18)) | ((w[i-15]) << (32 - (18)))) ^ ((w[i-15]) >> 3)) + w[i-16];
    ...
    VITIS_LOOP_30_3: for (int i = 0; i < 64; i++) {
#pragma HLS PIPELINE II=2
 uint32 t1 = h_val + ((((e) >> (6)) | ((e) << (32 - (6)))) ^ (((e) >> (11)) | ((e) << (32 - (11)))) ^ (((e) >> (25)) | ((e) << (32 - (25))))) + (((e) & (f)) ^ (~(e) & (g))) + k[i] + w[i];
        uint32 t2 = ((((a) >> (2)) | ((a) << (32 - (2)))) ^ (((a) >> (13)) | ((a) << (32 - (13)))) ^ (((a) >> (22)) | ((a) << (32 - (22))))) + (((a) & (b)) ^ ((a) & (c)) ^ ((b) & (c)));
        h_val = g; g = f; f = e;
    ...
    VITIS_LOOP_40_4: for (int j = 0; j < 8; j++) {
#pragma HLS PIPELINE II=1
 pkt p;
        p.data = res[j];
        p.keep = 0xF;
